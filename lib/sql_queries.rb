...
"SELECT Users.name, SUM(pledges.amount) AS pledged_amount FROM users INNER JOIN pledges ON Pledges.user_id = Users.id GROUP BY name ORDER BY pledged_amount;"
end
